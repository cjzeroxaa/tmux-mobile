...
export const CONNECTOR_COMPAT_VERSION = "8";

export const AGENT_CLOSE_CODE = {
  REPLACED: 4000,
  CONTROLLER_RESTARTING: 1012,
};
...
export const OP = {
  ...
  // { target: "%pane", ttlSeconds?: number } ->
  //   { operatorUrl, code, expiresAt, shareId, target }
