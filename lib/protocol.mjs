...
export const CONNECTOR_COMPAT_VERSION = "14";
...
// Raw bytes before base64 framing. Kept shared by connector and controller so
// an oversized JSONL record is quarantined locally instead of becoming a
