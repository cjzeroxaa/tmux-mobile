...
// "22": Command Center inventory includes the Agent-native conversation name
// extracted from Codex and Claude Code's local session metadata.
export const CONNECTOR_COMPAT_VERSION = "22";
