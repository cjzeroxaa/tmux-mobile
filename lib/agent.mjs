...
// connection that misses pongs forces a `close`, which drives the existing
// backoff reconnect below.
const PING_INTERVAL_MS = Number(process.env.AGENT_PING_INTERVAL_MS) || 10_000;
const PONG_TIMEOUT_MS = Number(process.env.AGENT_PONG_TIMEOUT_MS) || 25_000;
