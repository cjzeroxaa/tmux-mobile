...
export const localBackend = {
  ...
  // only boundary is the OS file permissions of the user the agent runs as, so a
  // file the user can read is readable here (and one they can't yields EACCES
  // from the OS). Returns base64 bytes + the real size; truncates to maxBytes.
