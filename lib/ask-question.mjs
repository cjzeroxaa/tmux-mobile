...
// or Claude's exit-plan-mode confirmation.
...
// The exit-plan-mode prompt = the plan header AND at least one numbered option
// with the ❯ cursor (so we don't fire on the header text alone mid-stream).
